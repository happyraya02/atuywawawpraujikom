            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 home-about-right">
                        <img class="img-fluid" src="{{asset('assets/frontend/img/about-img.jpg')}}" alt="">
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="single-service">
                            <div class="thumb">
                                <img src="{{asset('assets/frontend/img/about/s1.jpg')}}" alt="">
                            </div>
                            <a href="#">
                    ...
                    <div class="col-lg-4">
                        <div class="single-service">
                            <div class="thumb">
                                <img src="{{asset('assets/frontend/img/about/s2.jpg')}}" alt="">
                            </div>
                            <a href="#">
                    ...
                    <div class="col-lg-4">
                        <div class="single-service">
                            <div class="thumb">
                                <img src="{{asset('assets/frontend/img/about/s3.jpg')}}" alt="">
                            </div>
                            <a href="#">
