                ...
                <div class="row">
                    <div class="col-lg-8 posts-list">
                        ...
                        <div class="single-post row">
                            ...
                            <div class="col-lg-9 col-md-9 ">
                                <div class="feature-img">
                                    <img class="img-fluid" src="{{asset('assets/frontend/img/blog/feature-img2.jpg')}}" alt="">
                                </div>
                        ...
                        <div class="single-post row">
                            ...
                            <div class="col-lg-9 col-md-9">
                                <div class="feature-img">
                                    <img class="img-fluid" src="{{asset('assets/frontend/img/blog/feature-img3.jpg')}}" alt="">
                                </div>
                        ...
                        <div class="single-post row">
                            ...
                            <div class="col-lg-9 col-md-9">
                                <div class="feature-img">
                                    <img class="img-fluid" src="{{asset('assets/frontend/img/blog/feature-img4.jpg')}}" alt="">
                                </div>
                        ...
                        <div class="single-post row">
                            ...
                            <div class="col-lg-9 col-md-9">
                                <div class="feature-img">
                                    <img class="img-fluid" src="{{asset('assets/frontend/img/blog/feature-img5.jpg')}}" alt="">
                                </div>
